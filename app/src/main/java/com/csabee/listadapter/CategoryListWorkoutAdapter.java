...
public class CategoryListWorkoutAdapter extends com.idunnololz.widgets.AnimatedExpandableListView.AnimatedExpandableListAdapter{
    private Context context;
    private List<String> listDataHeader;
    private HashMap<String, List<Exercise>> listHashMap;
    CategoryListAdapter.EventListener listener;


    public CategoryListWorkoutAdapter(Context context, List<String> listDataHeader, HashMap<String, List<Exercise>> listHashMap) {
